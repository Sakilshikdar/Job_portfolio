...
import pic from '../../assets/images/web_image/web_2_1.png'
import pic2 from '../../assets/images/web_image/web_2_2.png'
import pic3 from '../../assets/images/web_image/web_2_3.png'
        ...
        <div style={{color:'#c2c3ca'}}>
            ...
            <div class=" grid grid-cols-1 lg:grid-cols-2 my-2">
                ...
                <div className='my-auto p-4 '>
                    <h1 class="text-5xl font-bold text-yellow-100">Ecommarce Webside</h1>
                    <div class="py-6">
                        ...
                        <p className='text-2xl'>• Home page have Details button and this page is protected.</p>
                    </div>

                    <div className='flex gap-3'>
                        <a href="https://django-ecommerce-fronted-46zamshhc-sakil-shikdars-projects.vercel.app/"> <div class="card-actions">
                            <button class="btn btn-primary">Live link</button>
                        </div></a>
                        <a href="https://github.com/Sakilshikdar/Django-Ecommerce-fronted"> <div class="card-actions">
                    ...
                    <div className='mt-4'>
                        ...
                        <p className='text-xl'>Github,ReactJS, Boostrap, Django, Django_rest_fremwork, Django_authenticate
                        </p>
                    </div>
                </div>
            </div>
